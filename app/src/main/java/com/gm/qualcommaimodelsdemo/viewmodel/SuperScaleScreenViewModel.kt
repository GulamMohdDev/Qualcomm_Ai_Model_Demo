...
@HiltViewModel
class SuperScaleScreenViewModel @Inject constructor(
    private val superResolutionAiModelRepository: SuperResolutionAiModelRepository
) :ViewModel(), Logs {
    override var TAG: String = "SuperScaleScreenViewModel"
    ...
    fun upScaleImage(bitmap: Bitmap) {
        ...
        viewModelScope.launch {
            val output = superResolutionAiModelRepository.upscale(bitmap)
    ...
    override fun onCleared() {
        super.onCleared()
        superResolutionAiModelRepository.close()
    }
